...
type Brand struct {
	...
	// 产品参数
	ProductParam ProductParam `gorm:"column:product_param;serializer:json;notnull;default:'{}';comment:'产品参数'" json:"productParam"`
...
type CpuParam struct {
	// 核心数
	CoreCount string `gorm:"column:core_count;notnull;comment:'核心数'" json:"coreCount"`
	// 核心频率
	CoreFrequency string `gorm:"column:core_frequency;notnull;comment:'核心频率'" json:"coreFrequency"`
}

type MemoryParam struct {
	// 频率
	Frequency string `gorm:"column:frequency;notnull;comment:'频率'" json:"frequency"`
	// 容量
	Capacity string `gorm:"column:capacity;notnull;comment:'容量'" json:"capacity"`
}
